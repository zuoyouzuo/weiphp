...
`qr_url`  varchar(255) NULL  COMMENT '二维码内容',
`code_name`  varchar(50) NULL  COMMENT '名称',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
INSERT INTO `wp_model` (`name`,`title`,`extend`,`relation`,`need_pk`,`field_sort`,`field_group`,`attribute_list`,`template_list`,`template_add`,`template_edit`,`list_grid`,`list_row`,`search_key`,`search_list`,`create_time`,`update_time`,`status`,`engine_type`,`addon`) VALUES ('qr_admin','扫码管理','0','','1','["action_name","code_name","group_id","tag_ids","material"]','1:基础','','','','','code_name:名称\r\nqr_code:二维码\r\naction_name:类型\r\nqr_url:二维码内容\r\ngroup_id:用户组\r\ntag_ids:标签\r\nids:操作:[EDIT]|编辑,[DELETE]|删除','10','','','1463999052','1491806477','1','MyISAM','QrAdmin');
...
INSERT INTO `wp_attribute` (`name`,`title`,`field`,`type`,`value`,`remark`,`is_show`,`extra`,`model_id`,`model_name`,`is_must`,`status`,`update_time`,`create_time`,`validate_rule`,`validate_time`,`error_info`,`validate_type`,`auto_rule`,`auto_time`,`auto_type`) VALUES ('qr_url','二维码内容','varchar(255) NULL','string','','','0','','0','','0','1','1491793468','1491793468','','3','','regex','','3','function');
INSERT INTO `wp_attribute` (`name`,`title`,`field`,`type`,`value`,`remark`,`is_show`,`extra`,`model_id`,`model_name`,`is_must`,`status`,`update_time`,`create_time`,`validate_rule`,`validate_time`,`error_info`,`validate_type`,`auto_rule`,`auto_time`,`auto_type`) VALUES ('code_name','名称','varchar(50) NULL','string','','用于区分二维码','1','','0','','1','1','1491794163','1491793920','','3','','regex','','3','function');
