	...
	function add() {
		...
		if (IS_POST) {
			...
			if ($Model->create () && $id = $Model->add ()) {
                                $data = D ( 'Home/QrCode' )->add_qr_code ( I ( 'action_name' ), 'QrAdmin', $id ); 
                                $map ['id'] = $id;
                                ...
                                $save ['qr_code'] = $data['qr_code'];
                                $save ['qr_url'] = $data['qr_url'];
				if ($save ['qr_code'] && $save ['qr_url']) {
